...
export class SubsetCreator {
    ...
    createSubset(config: SubsetConfig, subsetID: string) {
        ...
        //this.subsets[subsetID].mesh.setIndex(this.tempIndex);
    ...
    private initializeSubsetAttributes(subsetGeom: Mesh, model: Mesh) {
    ...
    private initializeSubsetGroups(subsetGeom: Mesh, model: Mesh) {
    ...
    private filterIndices(config: SubsetConfig, subsetID: string) {
        const geometry = this.subsets[subsetID].mesh;
    ...
    private resetGroups(geometry: Mesh) {
